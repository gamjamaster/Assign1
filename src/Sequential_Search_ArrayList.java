...
class Sequential_Search_ArrayList<T> implements Runnable {
    ...
    public Sequential_Search_ArrayList(List<T> list, T target) {
        this.list = list;
        this.target = target;
    }
    ...
    public void run() {
        ...
        System.out.println("Sequential Search (ArrayList) finished in " + (end - start)/1_000_000.0 + " ms, index=" + result);
    }
